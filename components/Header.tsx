        ...
        <div className="nav-overlay-inner">
          ...
          <div className="overlay-services">
            ...
            <div className="carousel overlay-carousel" id="overlayCarousel" aria-label="Services carousel">
              {[
                { t: "Web Design & Development", d: "Bespoke builds from architecture through launch, on WordPress or a custom stack.", img: "/assets/img/service-web.jpg", alt: "Website design and build" },
                { t: "Branding & Identity", d: "Logo, visual identity, and guidelines that carry consistently everywhere.", img: "/assets/img/service-brand.jpg", alt: "Brand identity system" },
                { t: "SEO & AI Optimization", d: "Search-ready foundations tuned for traditional and generative engines.", img: "/assets/img/service-seo.jpg", alt: "Search analytics" },
                { t: "Ecommerce & Website Care", d: "Storefronts built to convert, plus hosting and care after launch.", img: "/assets/img/service-ecom.jpg", alt: "Checkout and payment" },
              ].map((s) => (
